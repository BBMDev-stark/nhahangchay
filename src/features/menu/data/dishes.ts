...
const RAW_DISHES: RawDish[] = [
  ...
  item("Chả Giò", 65_000, "khai-vi", "cha-gio", { tags: ["vegetarian", "best-seller"] }),
  ...
  item("Gỏi Hương Sen", 100_000, "salad", "goi-huong-sen", { tags: ["vegetarian", "best-seller"], featured: true }),
  ...
  item("Nấm Mối Kho Tiêu Xanh", 80_000, "mon-chinh", "nam-moi-kho-tieu-xanh", { tags: ["vegetarian", "chef-choice"] }),

  // Cơm
  item("Cơm Cung Đình Gói Lá Sen", 150_000, "com", "com-cung-dinh-goi-la-sen", { tags: ["vegetarian", "best-seller"], featured: true }),
  ...
  item("Mì Xào Giòn", 85_000, "mi", "mi-xao-gion", { tags: ["vegetarian", "best-seller"] }),
  ...
  // Lẩu
  item("Lẩu Nấm Mối", 360_000, "lau", "lau-nam-moi", { tags: ["vegetarian", "chef-choice"], featured: true }),
  item("Lẩu Mắm", 380_000, "lau", "lau-mam"),
  item("Lẩu Nấm Thái", 380_000, "lau", "lau-nam-thai"),

  // Tráng miệng
  item("Chè Hạt Sen Long Nhãn", 25_000, "dessert", "che-hat-sen-long-nhan", { tags: ["vegetarian", "best-seller"] }),
